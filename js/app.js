...
// ---- Config ----
// Vercel deployment: frontend dan backend berada dalam 1 domain, gunakan relative path ''
const API_BASE_URL = '';
...
downloadBtn.addEventListener('click', async () => {
  ...
  try {
    ...
    // Trigger download — Di Vercel serverless, gunakan link download langsung
    // agar kecepatan maksimal dan terhindar dari batasan payload serverless (4.5MB).
